...
exports.updateTransaksi =
    async (request, response) => {
        try {
            /** get id that will be update */
            let id_transaksi =
                request.params.id_transaksi
            ...
            let dataTransaksi = {
                ...
                id_user: request.body.id_user,
                id_meja: request.body.id_meja,
                nama_pelanggan: request.body.nama_pelangan,
            ...
            /** execute delete all detail of selected
             * transaksi
             */
